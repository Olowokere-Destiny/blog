...
function Post({id, title, summary, publicationDate}: PostProp) {
  return (
    <Link href={`/post/${id}`} className="block py-6 hover:bg-[#fff7cb] dark:hover:bg-gray-800 px-4 md:px-14 lg:px-20 md:rounded-md">
      <h3 className={`${lora.className} text-[1.2rem] md:text-base lg:text-[1.2rem] text-center font-[600]`}>
        {title}
      </h3>
