...
function NavBar({ dark, setDark }: NavBarProps) {
  ...
  return (
    <div
      className={`dark:bg-gray-800 sticky top-0 bg-white w-full flex justify-between uppercase tracking-wide px-3 md:px-8 lg:px-12 md:py-6 py-2 text-base ${merriweather.className}`}
    >
